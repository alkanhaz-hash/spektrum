...
import {
  ...
  MessageSquarePlus, Check, Trash2, Send, X, Pencil, ExternalLink
} from "lucide-react";
import { Skeleton } from "@/components/ui/skeleton";
import { Badge } from "@/components/ui/badge";
import { useAuth } from "@/contexts/AuthContext";
import { getUserProfile, updateUserProfile, ensureUserProfile, UserProfile } from "@/lib/auth-service";
import { getStoriesByAuthor, Story, getAnsweredQuestions, getUnansweredQuestions, sendAnonymousQuestion, answerQuestion, deleteQuestion, AnonymousQuestion } from "@/lib/firestore-service";
...
export default function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<"stories" | "qa">("stories");
